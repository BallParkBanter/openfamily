      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            IconButton(tooltip: 'Profile', visualDensity: VisualDensity.compact, onPressed: onProfile, icon: const Icon(Icons.person_outline, size: 20)),
            IconButton(key: const Key('following-stop'), tooltip: 'Stop following', visualDensity: VisualDensity.compact, onPressed: onStop, icon: const Icon(Icons.close, size: 20)),
          ],
        ),
      ),
    );
