...
class VectorTilePainter extends CustomPainter {
  ...
  /// Whether the last paint drew every symbol it met (none were waiting on
  /// a text painter). See DelayPainter.complete.
  bool get lastPaintComplete =>
      _painterProvider.symbolsWithoutPainter().isEmpty;
