...
void main() {
  ...
  testWidgets('Everyone chip: a button the rig finds by "Everyone: …"; tap fires (a summary only since Round 4 - no cards to raise)', (t) async {
    ...
    expect(taps, 1);
    final BoxDecoration deco = t.widget<Container>(find.descendant(of: find.byKey(const Key('everyone-chip')), matching: find.byType(Container))).decoration as BoxDecoration;
